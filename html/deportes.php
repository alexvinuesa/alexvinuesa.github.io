...
<header id="portada-deportes">
  <?php session_start();?>
            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse justify-content-end" id="navbarNav">
                    <ul class="navbar-nav">
                        ...
                        <li class="nav-item ms-4">
                            <a id="menu" class="nav-link active" aria-current="page" href="eventos_deporte">VER EVENTOS</a>
                        </li>
                        <li class="nav-item ms-4">
                            <a id="menu" class="nav-link active" href="mostrardeporte">VER ACTIVIDADES</a>
                        </li>
                        <li class="nav-item ms-4">
                            <a id="menu" class="nav-link active" href="creardeporte">CREAR ACTIVIDAD</a>
                        </li>
        ...
        <div class="container" id="deportes">
            <div class="row">
                <h6>SOCIAL CONNECTION</h6>
                <h1>Haz que cada <span style="color: white;">movimiento</span><br>
                    cuente y logra la <span style="color: white;">victoria.</span> </h1>
                <p style="width: 450px;">
                ¡Prepárate para la máxima adrenalina y la emoción desbordante! Nuestros eventos deportivos te llevarán a vivir experiencias inolvidables mientras disfrutas de la pasión y el espíritu competitivo
                </p>

            </div>
            <a class="nav-link active" id="buscar" href="#">MAS INFORMACIÓN</a>
        </div>
    </header>
    <?php
...
$sql2 = "SELECT nombres FROM nomdep";
...
while($row = mysqli_fetch_assoc($result)) {
  ...
  echo '<a href="mostrareventodeporte.php?idevent='.$row['idevent'].'"><img src="data:image/jpeg;base64,'.base64_encode($row['imatge']).'" /></a>';
  echo '<br>';
...
<div class="containerbot">
        <a class="ver-mas" href="eventos_deporte.php">Ver más</a>
    </div>
    </div>

</div>
<div id="creardeporte" class="container-fluid mt-5 mb-5">
        <div class="container">
            <div class="row">
                <div class="col-md-6"></div>
                <div id="creardeporte_texto" class="col-md-6 text-black">
                    <h2>¡Desafía tus límites y alcanza tu máximo potencial! </h2>
                    <h4>Únete a nosotros y crea un evento deportivo inolvidable</h4>
                    <p>Ponte tu ropa favorita, llama a tus amigos y ¡sal a disfrutar!</p>
    ...
    <div id="partners" class="container mb-5">
        ...
        <div class="row">
            ...
            <img class="col-md-3 mb-5" height="120px" src="../images/nike.png" alt="">
        </div>
    </div>
