...
<body>
    ...
    <?php session_start();?>
            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse justify-content-end" id="navbarNav">
                    <ul class="navbar-nav">
                        ...
                        <li class="nav-item ms-4">
                            <a id="menu" class="nav-link active" href="mostrarcomida">VER ACTIVIDADES</a>
                        </li>
        ...
        <div class="container" id="deportes">
            <div class="row">
                <h6 class="text-white">SOCIAL CONNECTION</h6>
                <h1 class="text-white">¡Hagamos que<span style="color: black;"> la noche</span><br>
                    sea inolvidable!</h1>
                <p class="text-white" style="width: 450px;">
            ...
            <a class="nav-link active" id="buscargastronomia" href="#">MAS INFORMACIÓN</a>
        </div>
    </header>
    <?php
...
echo '<label class="filter-label" for="filtro_act">Filtrar por comida:</label>';
echo '<select class="filter-select" name="filtro_act" id="filtro_act">';
echo '<option value="todos">Todos</option>';
$sql2 = "SELECT tipocom FROM nomcomida";
$result2 = mysqli_query($conn, $sql2);
while($row2 = mysqli_fetch_assoc($result2)) {
  $tipocom = $row2['tipocom'];
  if ($tipocom == $filtro_act) {
    echo '<option value="'.$tipocom.'" selected>'.$tipocom.'</option>';
  } else {
...
while ($row = mysqli_fetch_assoc($result)) {
  ...
  echo '<a href="mostrareventogastronomia.php?idevent='.$row['idevent'].'"><img src="data:image/jpeg;base64,'.base64_encode($row['imatge']).'" /></a>';
  echo '<br>';
...
<div class="containerbot">
        <a class="ver-mas" href="eventos_gastronomia.php">Ver más</a>
    </div>
    </div>
    ...
    <div id="creargastronomia" class="container-fluid mt-5 mb-5">
            <div class="row">
                ...
                <div class="col-lg-6 col-md-6 text-center">
                    <img class="fotogastronomia" src="../images/crear_gastronomia.jpg" width="100%" height="100%" alt="">
                </div>
            </div>
    </div>
