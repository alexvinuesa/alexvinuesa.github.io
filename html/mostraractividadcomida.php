...
<?php session_start();?>
            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse justify-content-end" id="navbarNav">
                    <ul class="navbar-nav">
                        ...
                        <li class="nav-item ms-4">
                            <a id="menu" class="nav-link active" aria-current="page" href="eventos_comida">VER EVENTOS</a>
                        </li>
                        <li class="nav-item ms-4">
    ...
    ?>
        ...
        <div>
            <h1><?php echo $row['nomact']; ?></h1>
            <p> <?php echo $row['descripcio']; ?></p>
            <p>Fecha: <?php echo $row['date']; ?></p>
            <p>Hora Inicio: <?php echo $row['hour']; ?></p>
            
            <p>Precio: <?php echo $row['price']; ?>€</p>
            <p>Tipo evento: <?php echo $row['comida']; ?></p>
            <p>Telefono: <?php echo $row['telefonoact']; ?></p>
