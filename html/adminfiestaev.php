...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['borrar_actividad_id'])) {
    ...
    $sql_borrar = "DELETE FROM fiestaevent WHERE idevent = ?";
    ...
    if ($stmt_borrar) {
        ...
        if ($result_borrar) {
            ...
            // Redirige al usuario de vuelta a la página adminfiestaev.php o muestra un mensaje de éxito
            header("Location: adminfiestaev.php");
            exit();
        } else {
