            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse justify-content-end" id="navbarNav">
                    <ul class="navbar-nav">
                        ...
                        <li class="nav-item ms-4">
                            <a id="menu" class="nav-link active" href="crearcom">CREAR ACTIVIDAD</a>
                        </li>
...
// Obtener el valor del menú desplegable para nomcomida
...
// Generación del menú desplegable para nomcomida
...
?>
    ...
    while($row = mysqli_fetch_assoc($result)) {
      ...
      echo "<br>";
      echo '<a href="mostraractividadcomida.php?id='.$row['id'].'"><button>Unirse</button></a>';
      echo "<br>";
      echo "<br>";
      echo '</div>';
      echo '</div>';
