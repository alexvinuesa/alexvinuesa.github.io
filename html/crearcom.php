...
<html>
  ...
  <body>
    ...
    <h1>Crear actividad comida</h1>
    <form action="../php/crearcomida.php" method="post">

  <label for="nomact">Nombre de la actividad:</label>
  <input type="text" id="nomact" name="nomact" required><br>
  <label for="tipocom">Tipo:</label>
  ...
  <input type="number" id="telefonoact" name="telefonoact"><br>
