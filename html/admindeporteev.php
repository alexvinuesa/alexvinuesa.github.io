...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['borrar_actividad_id'])) {
    ...
    $sql_borrar = "DELETE FROM deporteevent WHERE idevent = ?";
    ...
    if ($stmt_borrar) {
        ...
        if ($result_borrar) {
            ...
            // Redirige al usuario de vuelta a la página admindeporteev.php o muestra un mensaje de éxito
            header("Location: admindeporteev.php");
            exit();
        } else {
