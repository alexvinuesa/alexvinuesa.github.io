...
$sql = "INSERT INTO fiestaevent (nomevent, descripcioevent, dateevent, hourinici,hourfinal, priceevent, fiesta, imatge, telefono, email,comunidad, provincia, municipio, calle,link) 
        VALUES ('$nomevent', '$descripcioevent', '$dateevent', '$hourinici','$hourfinal', '$priceevent', '$tipo', '$contenido_imagen', '$telefono', '$email','$comunidad','$provincia','$municipio','$calle','$link')";
        
if (mysqli_query($conn, $sql)) {
    echo "Actividad creada correctamente";
    header("Location: ../html/eventos_fiesta.php");
    exit();
} else {
