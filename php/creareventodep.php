...
$sql = "INSERT INTO deporteevent (nomevent, descripcioevent, dateevent, hourinici,hourfinal, priceevent, deporte, imatge, telefono, email, comunidad, provincia, municipio, calle,link) 
        VALUES ('$nomevent', '$descripcioevent', '$dateevent', '$hourinici','$hourfinal', '$priceevent', '$deporte', '$contenido_imagen', '$telefono', '$email','$comunidad','$provincia','$municipio','$calle','$link')";
        
if (mysqli_query($conn, $sql)) {
    echo "Actividad creada correctamente";
    header("Location: ../html/eventos_deporte.php");
    exit();
} else {
